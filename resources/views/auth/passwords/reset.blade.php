                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-portlet p-4">
                        <div class="kt-login__signin">
                            ...
                            <form class="kt-form" action="{{route('password.update')}}" method="POST" id="kt_login_form">
                                @csrf
                                <input type="hidden" name="token" value="{{ $token }}">
                                <div class="input-group">
                                    <input  type="text" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="kt-login__actions">
                                    <button  class="btn btn-primary  btn-elevate kt-login__btn-primary btn-block">Change Password</button>
                                </div>
                            </form>
                        </div>
