...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>Reclutas | Reset Password</title>
                ...
                <div class="kt-login__container">
                    ...
                    <div class="kt-portlet p-4">
                        <div class="kt-login__signin">
                            ...
                            <form class="kt-form" action="{{route('password.email')}}" method="POST" id="kt_login_form">
                                @csrf
                                ...
                                <div class="kt-login__actions">
                                    <button class="btn btn-primary  btn-elevate btn-block">Send Reset Link</button>
                                </div>
                            </form>
                        </div>
